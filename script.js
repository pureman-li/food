...
const recipes = [
    {
        ...
        description: '枣花酥是北京传统小吃“八大件”糕点之一，承载着历史记忆和美好祝福。（详见本书6-9页）',
        image: '枣花酥.png'
    },
    {
        name: '荠菜炒鸡蛋',
        ingredients: ['鸡蛋', '荠菜', '盐'],
        description: '荠菜又叫“春菜”，春季食用荠菜炒鸡蛋有祈求平安吉祥、家宅兴旺的寓意。（详见本书12-16页）',
        image: '荠菜炒鸡蛋.png'
    },
    {
        name: '小葱拌豆腐',
        ingredients: ['葱', '油', '豆腐'],
        description: '小葱拌豆腐做法极简，味道鲜美，兼具质朴本味与清正的寓意，是国人喜爱的家常菜之一。（详见本书19-22页）',
        image: '小葱拌豆腐.png'
    },
    {
        name: '汤圆',
        ingredients: ['面粉', '糯米粉', '黑芝麻馅'],
        description: '汤圆是我国必不可少的节庆美食之一，象征合家幸福，团圆美满。（详见本书27-31页）',
        image: '汤圆.png'
    },
    {
        name: '腌笃鲜',
        ingredients: ['笋', '火腿', '猪肉'],
        description: '竹笋在中国文化史上是兼具自然意趣与人文情怀的独特符号，承载着从精神寄托到民生滋味的双重价值。（详见本书133-134页）',
        image: '腌笃鲜.png'
    },
    {
        name: '担担面',
        ingredients: ['面条', '辣椒', '水'],
        description: '担担面是川渝地区的特色美食，也是市井烟火气的象征。（详见本书86-89页）',
        image: '担担面.png'
    },
    {
        name: '烤肉',
        ingredients: ['烤炉', '油', '猪肉'],
        description: '烤肉讲究“自烤自食”，鲜肉在炭火的炙烤下散发出别样的风味，是亲友相聚、邻里往来中不可或缺的“饮食社交”。（详见本书61-65页）',
        image: '烤肉.png'
    },
    {
        name: '文思豆腐',
        ingredients: ['豆腐', '水', '刀'],
        description: '文思豆腐展现了中式烹饪“食不厌精，脍不厌细”的追求，是一道经典的淮扬菜。（详见本书69-72页）',
        image: '文思豆腐.png'
    },
    {
        name: '肉燕',
        ingredients: ['面皮', '肉馅', '水'],
        description: '肉燕是福州地区节庆宴客、婚丧嫁娶等重要场合的必备菜肴，它形似飞燕，寓意“平安吉祥”。（详见本书78-81页）',
        image: '肉燕.png'
    }
];
